...
class Cliente:
    ...
    def set_nome(self, nome):
        if nome == "": raise ValueError("Nome deve sr informado")
        self.__nome = nome
...
class ClienteUI:
    ...
    def salvar(cls):
        ...
        json.dump(cls.__objetos, arquivo, default = Cliente.tp )
    ...
    def abrir(cls):
        ...
        except FileNotFoundError: #acontece quando o arquivo não existe
            pass                  # não faz nada
