...
class Service:
    ...
    @staticmethod
    def endereco_inserir( nome, endereco, id_cliente):
        obj = Endereco(0, nome, endereco, id_cliente)
        EnderecoDAO().inserir(obj)
    @staticmethod
    def endereco_listar():
        return EnderecoDAO().listar()
    @staticmethod
    def endereco_listar_id(id):
        return EnderecoDAO().listar_id(id)
    @staticmethod
    def endereco_atualizar(id, nome, endereco, id_cliente):
        obj = Endereco(id, nome, endereco, id_cliente)
        EnderecoDAO().atualizar(obj)
    @staticmethod
